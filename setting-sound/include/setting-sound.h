 ...
 *
 */
#ifndef __SETTING_SOUND_H__
#define __SETTING_SOUND_H__
...
typedef struct _SettingSoundUG SettingSoundUG;

/**
 * Setting Sound UG context
 * all UG function has void* as an agument. this is casted back to SettingSoundUG
 * and the functions access app context.
 */
struct _SettingSoundUG {
	ui_gadget_h ug;

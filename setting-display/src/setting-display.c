                                          ...
                                          void *priv)
{
	...
	setting_create_Gendial_itc("type1", &(displayUG->itc_1text_1icon));
...
static void setting_display_ug_on_key_event(ui_gadget_h ug, enum ug_key_event event, app_control_h service, void *priv)
{
	SETTING_TRACE_BEGIN;
	SETTING_TRACE_END;
}
